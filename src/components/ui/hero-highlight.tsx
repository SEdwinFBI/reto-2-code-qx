...
export const HeroHighlight = ({
  ...
  // Patrones SVG para temas claro y oscuro
  const dotPatterns = {
    light: {
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-linear-to-r from-primary to-blue-500 px-1 pb-1 dark:from-indigo-500 dark:to-purple-500`,
        className,
      )}
    >
      {children}
